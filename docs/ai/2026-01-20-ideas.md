---
id: 01KFEH5DVG54S8NZ55QZ4PDCM6
status: draft
createdAt: 2026-01-20T20:22:30+00:00
...
### 1. Add CLAUDE.md for repository documentation :white_check_mark:
...
### 2. Add missing test for runner.js :white_check_mark:
...
### 3. Export MIN_INTERVAL_MS constant from index.js :white_check_mark:
...
### 4. Add JSDoc for Job type in CLI :white_check_mark:
...
### 5. Fix duplicate sound in array :white_check_mark:
...
### 7. Add validation for job ID format :white_check_mark:
...
### 11. Add test for CLI commands :white_check_mark:
...
### 17. Improve parsePlistFilename for hyphenated namespaces :white_check_mark:
...
**Resolution:** Dots are now blocked in job IDs via `validateJobId()`, eliminating this parsing ambiguity.
